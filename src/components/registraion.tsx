...
const Registration = (props: propsobj) => {
    ...
    return (
        <div className="registration">
            ...
            <button type='submit' onClick={submit} disabled={(props.isRegistered || props.wallet === undefined) ? true : false} style={{ opacity: props.isRegistered ? 0.5 : 1 }}>Get early access</button>
        </div>
    )
}
